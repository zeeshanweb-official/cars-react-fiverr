...
class AdminSignUp extends Component {
    ...
    onRegisterClick = () => {
        if(this.state.password === this.state.confirm_password){
            this.props.registerRequest({email:this.state.email ,phone_number: this.state.phone_number, 'password': this.state.password})
        }
    }
                    ...
                    <Form>
                       <Card>
                           ...
                           <Card.Content>
                                ...
                                <Form.Input type="email" onChange={this.onChange} name='email' placeholder='your@email.com' label='Your Email' required />
