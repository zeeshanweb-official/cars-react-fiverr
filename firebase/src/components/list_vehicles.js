    ...
    render() {
        ...
        return (
            <div style={{ marginTop: '20px', width: '96%', marginLeft: '2%' }}>
                ...
                <div style={{ display: 'flex', marginTop: '10px' }}>
                    <Card style={{ flex: 1 }}>
                        <Card.Content>
                            ...
                            <Divider />
                            <Dropdown options={this.state.makes} onChange={onDropDownChange} 
                            selection fluid placeholder='By Car Make' /><br />
                            <Dropdown options={this.state.models.length>0?this.state.models:''} onChange={onModelsDropDownChange} 
                            selection fluid placeholder='By Car Model' /><br />
                        </Card.Content>
                    </Card>
                </div>
                <div style={{ width: '100%', paddingTop: '7px', display: 'flex', flexFlow: 'wrap', justifyContent: 'start' }}>
                ...
                <ModalBuy open={open} changeModels={this.changeModels} onClose={this.onModalClose} makes={this.state.makes} models={models} />
            </div>
        );
    }
